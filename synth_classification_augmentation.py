...
def get_confusion_stats(model,model_name,seq_list,save_file=True):#seqs,labels,seq_name):
    ...
    for fold in cvs:
        ...
        for a in augs:
            ...
            for model_type in models_to_try:
                ...
                p_res_df = get_confusion_stats(model,model_name,seq_list,save_file=f"{out_dir}/{combo_name}_confmat.png")
